              ...
              <TR>
                <TD style={textStyle}>
                  ...
                  <h1 style={bookingTitle}>
                    Расскажите {hostName} {hostLastName} что вам больше всего понравилось <br />
                    <span> и мы сможем сделать в следующий раз незабываемую поездку.</span>
                  </h1>
                  <EmptySpace height={20} />
                  <div>
                    Вы только что проверили, так что сейчас идеальное время, чтобы написать свой отзыв.
                    </div>
                  <EmptySpace height={20} />
                  <div>
                  Отзывы — важная часть сообщества {sitename}. Пожалуйста, найдите минутку, чтобы предоставить вашему хосту несколько полезных отзывов -
                     это займет всего несколько минут.
                    </div>
                  <EmptySpace height={50} />
                  <div>
                    <a href={messageURL} style={buttonStyle}>Оставить отзыв</a>
                  </div>
