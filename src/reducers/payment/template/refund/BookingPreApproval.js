    ...
    return (
      <Layout>
        ...
        <Body textStyle={textStyle}>
          ...
          <div>
            {hostName} предварительно одобрил ваш запрос на {listTitle}.
                        Вы можете пойти дальше и <a style={linkText} href={contactURL}>забронировать</a> заранее утвержденные даты прямо сейчас.
                    </div>
          <EmptySpace height={20} />
          <div>
                        С уважением, <br />
