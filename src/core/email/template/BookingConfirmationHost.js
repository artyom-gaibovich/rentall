...
class BookingConfirmationHost extends React.Component {
  ...
  render() {
    ...
    const checkInDateShort = checkIn != null ? moment(checkIn).format('Do MMMM') : '';
    const guestJoinedYear = guestJoinedDate != null ? moment(guestJoinedDate).format('YYYY') : '';
    const itineraryURL = `${url}/users/trips/itinerary/${reservationId}`;
        ...
        <div>
              ...
              <TR>
                <TD style={textStyle}>
                  ...
                  <h1 style={bookingTitle}>
                    Новое бронирование подтверждено! <br />
                    <span>{guestName} arrives</span> <br />
                    <span>{checkInDateShort}</span>
                  </h1>
                  <EmptySpace height={20} />
                  <div>
                    Отправьте сообщение, чтобы подтвердить детали регистрации или приветствовать {guestName}.
                    </div>
                  <EmptySpace height={20} />
                  <div>
                    {
                  ...
                  <div>
                    <a href={messageURL} style={buttonStyle}>Связаться с гостем</a>
                  </div>
          ...
          <Table width="100%">
            <TBody>
              <TR style={textStyle}>
                <TD style={space}>
                  <span style={subTitle}>Регистрация</span><br />
                ...
                <TD style={space}>
                  <span style={subTitle}>Проверить</span><br />
                  <EmptySpace height={10} />
              ...
              <TR style={textStyle}>
                <TD>
                  <div>
                    <span style={subTitle}>Гость</span><br />
                    <EmptySpace height={10} />
                    <span>{guests}</span>
                  </div>
                </TD>
                ...
                <TD>
                  <div>
                    <span style={subTitle}>Код подтверждения</span><br />
                    <EmptySpace height={10} />
              ...
              <TR style={textStyle}>
                ...
                <TD>
                  <div>
                    <a href={itineraryURL} style={linkText}> Посмотреть маршрут</a>
                  </div>
                </TD>
              </TR>
