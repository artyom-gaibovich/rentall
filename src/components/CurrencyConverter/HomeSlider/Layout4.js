      ...
      <div>
        <div className={cx(s.bannerLayoutContainer)}>
          ...
          <div className={s.searchFormContainer}>
            <h1>
              <span style={{ WebkitTextFillColor: '#ffffff', 'font-weight': 'bold', 'text-shadow': '#000 3px 0 3px' }}>За впечатлениями вместе с </span>
              <span style={{ WebkitTextFillColor: '#ff3a40', 'font-weight': 'bold', 'text-shadow': '#000 3px 0 3px' }}>GOODTRIP</span>
            </h1>
            {
