...
class Page3 extends Component {
  ...
  async handleClick(e) {
    ...
    const bedTypesValue = Object.keys(bedTypes).map(key => bedTypes[key]);

    const updatedBedTypesArray = (bedTypesValue && bedTypesValue.length > 0) ? bedTypesValue.slice(0) : [];
    const updatedBedCount = beds + 1;
    let obj = {};
