            ...
            <TBody>
              <TR>
                <TD style={textStyle}>
                  ...
                  <EmptySpace height={20} />
                  <div>
                  С сожалением сообщаем вам, что ваш хозяин {hostName} отклонил ваш запрос
					          {' '}{confirmationCode} начиная с {checkInDate}. В соответствии с политикой отмены
                      вам вернут деньги и уведомят.
					        		</div>
