  ...
  const facebookLogin = async () => {
    if (req.user) {
      ...
      if (userLogin) {
        ...
        let picture;
        const isDefault = profile._json.picture.data.is_silhouette;
        ...
        const updatedFirstName = capitalizeFirstLetter(profile._json.first_name);
        const updatedLastName = capitalizeFirstLetter(profile._json.last_name);
