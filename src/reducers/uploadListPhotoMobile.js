...
const uploadListPhotoMobile = (app) => {
  ...
  app.post('/uploadListPhoto', (req, res, next) => {
    next();
          ...
          const smallImage = await new Promise((resolve, reject) => {
            files && files.length > 0 && files.map((item, index) => {
              sharp(files[index].path)
                                ...
                                .toFile(`${fileuploadDir}small_${files[index].filename}`, (err) => {
                                  if (files) {
                                    resolve(files);
                                  } else {
                                    reject(error);
          ...
          const xSmallImage = await new Promise((resolve, reject) => {
            files && files.length > 0 && files.map((item, index) => {
              sharp(files[index].path)
                                ...
                                .resize(216, null)
                                // .crop(sharp.strategy.entropy)
                                .toFile(`${fileuploadDir}x_small_${files[index].filename}`, (err) => {
                                  if (files) {
                                    resolve(files);
                                  } else {
                                    reject(error);
          ...
          const mediumImage = await new Promise((resolve, reject) => {
            files && files.length > 0 && files.map((item, index) => {
              sharp(files[index].path)
                                ...
                                .resize(450, null)
                                // .crop(sharp.strategy.entropy)
                                .toFile(`${fileuploadDir}x_medium_${files[index].filename}`, (err) => {
                                  if (files) {
                                    resolve(files);
                                  } else {
                                    reject(error);
          ...
          const largeImage = await new Promise((resolve, reject) => {
            files && files.length > 0 && files.map((item, index) => {
              sharp(files[index].path)
                                ...
                                .resize(900, null)
                                // .crop(sharp.strategy.entropy)
                                .toFile(`${fileuploadDir}x_large_${files[index].filename}`, (err) => {
                                  if (files) {
                                    resolve(files);
                                  } else {
                                    reject(error);
          ...
          const largeImageSize = await new Promise((resolve, reject) => {
            files && files.length > 0 && files.map((item, index) => {
              sharp(files[index].path)
                                ...
                                .resize(1280, null)
                                // .crop(sharp.strategy.entropy)
                                .toFile(`${fileuploadDir}xx_large_${files[index].filename}`, (err) => {
                                  if (files) {
                                    resolve(files);
                                  } else {
                                    reject(error);
