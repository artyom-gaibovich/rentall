        ...
        <div className={cx(headerDesignClass)}>
          <div className={s.root} key={new Date().getTime()}>
            ...
            <div className={s.container}>
              <Navbar
                fluid className={cx({[s.rentAllHeader]: location === "/" || location === '/home'}, 'rentAllHeader', borderClass, { "homeHead": location === '/' || location === '/home' })}
    ...
    return (
      <div className={cx(headerDesignClass)}>
        <div className={s.root}>
          ...
          <div className={s.container}>
            <Navbar
              fluid className={cx(s.rentAllHeader, 'rentAllHeader', borderClass,
