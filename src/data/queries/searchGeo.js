    ...
    async resolve(_, { query }) {
      ...
      `, {
            ...
            const formattedResults = results.map(result => {
                if (result.locality) {
                    return { type: 'geo', displayName: `${result.locality}, ${result.area}, ${result.province}`, value: `${result.locality}, ${result.area}, ${result.province}` };
                } else if (result.area) {
                    return { type: 'geo', displayName: `${result.area}, ${result.province}`, value: `${result.area}, ${result.province}` };
                } else {
