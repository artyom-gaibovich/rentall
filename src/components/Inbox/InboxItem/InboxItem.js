...
class InboxItem extends Component {
  ...
  render() {
    ...
    const createdDate = createdAt != null ? moment(createdAt).format('MM/DD/YYYY') : '';
    const start = startDate != null ? `(${moment(startDate).format('MM/DD/YYYY')}` : '';
    const end = endDate != null ? ` - ${moment(endDate).format('MM/DD/YYYY')})` : '';
    let isRead;
