...
class Calendar extends Component {
  ...
  render() {
    ...
    const title = stepTwoDetails && stepTwoDetails.title;
    const description = stepTwoDetails && stepTwoDetails.description;
    const coverPhoto = stepTwoDetails && stepTwoDetails.coverPhoto;
    const coverImage = stepTwoDetails && stepTwoDetails.listPhotos.find(o => o.id == coverPhoto);
    const path = '/images/upload/x_medium_';
    let showImage;
    if (coverImage) {
          ...
          <Col xs={12} sm={12} md={12} lg={12} className={s.landingContent}>
            <div>
              ...
              <div className={s.lableWeight}>
                <p className={cx(s.bookedWidth)}><span className={cx(s.notAvailableColor, 'availableRTl')} /><FormattedMessage {...messages.booked} /></p>
                <p className={s.calenderColorText}><span className={cx(s.bookedColor, 'availableRTl')} /><FormattedMessage {...messages.notAvailable} /></p>
                <p className={s.calenderColorText}><span className={cx(s.availableColor, 'availableRTl')} /><FormattedMessage {...messages.availableLabel} /></p>
                <p className={s.calenderColorText}><span className={cx(s.specialColor, 'availableRTl')} /><FormattedMessage {...messages.sessionPrice} /></p>
              </div>
