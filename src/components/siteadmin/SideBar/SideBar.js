...
class SideBar extends Component {
  ...
  render() {
    ...
    const reviewManagementArray = ['/siteadmin/reviews', '/siteadmin/reviews/edit-review/', '/siteadmin/write-reviews'];
    const adminManagementArray = ['/siteadmin/admin-users', '/siteadmin/admin-roles'];
    const homePageArray = ['/siteadmin/home/caption', '/siteadmin/home/banner', '/siteadmin/home/footer-block', '/siteadmin/popularlocation', '/siteadmin/home/static-info-block', '/siteadmin/home/home-banner', '/siteadmin/popularlocation/add'];
    const whyBecomeHostPageArray = ['/siteadmin/whyHost/Block1', '/siteadmin/whyHost/Block2', '/siteadmin/whyHost/Block3', '/siteadmin/whyHost/Block4', '/siteadmin/whyHost/Block5', '/siteadmin/whyHost/Block6', '/siteadmin/whyHost/Block7'];
    const listSettingStep1 = ['/siteadmin/listsettings/1', '/siteadmin/listsettings/2', '/siteadmin/listsettings/3', '/siteadmin/listsettings/4', '/siteadmin/listsettings/5', '/siteadmin/listsettings/6', '/siteadmin/listsettings/7', '/siteadmin/listsettings/8', '/siteadmin/listsettings/9', '/siteadmin/listsettings/10', '/siteadmin/listsettings/11', '/siteadmin/listsettings/12', '/siteadmin/listsettings/101'];
    const listSettingStep3 = ['/siteadmin/listsettings/13', '/siteadmin/listsettings/14', '/siteadmin/listsettings/15', '/siteadmin/listsettings/16', '/siteadmin/listsettings/17', '/siteadmin/listsettings/18', '/siteadmin/listsettings/19'];
                                ...
                                validatePrivilege(14, privileges) && <div>
                                  ...
                                  <Collapse in={this.state.step1} className={s.subMenu}>
                                    <div>
                                      ...
                                      <li className={cx({ [s.active]: location === '/siteadmin/listsettings/101' })}>
                                        <Link to={'/siteadmin/listsettings/101'} className={cx(s.sideNavitem, s.disPlayTable)} onClick={() => this.openClose()}>
                                          <span className={s.disPlayTabelCell}>
                                            <FontAwesome.FaArrowRight className={cx(s.navigationIcon, 'sideArrowRTL')} />
                                          </span>
                                          <span className={s.disPlayTabelCell}><FormattedMessage {...messages.fish} /></span>
                                        </Link>
                                      </li>
                                    </div>
                                  </Collapse>
