...
const UserFish = new ObjectType({
  ...
  fields: {
    ...
    fishId: {
      type: StringType,
      resolve(userFish) {
        return userFish.fishId;
      },
    },
    listsettings: {
      type: ListSettings,
      resolve(userFish) {
        return userFish.getListSettings();
      },
    },
  },
});
...
const ShowListingType = new ObjectType({
  ...
  fields: {
    ...
    fish: {
      type: new List(UserFish),
      resolve(listing) {
        return listing.getUserFish();
      },
    },
    listBedTypes: {
    ...
    blockedDates: {
      ...
      async resolve(listBlock) {
        const today = getDateUsingTimeZone(listBlock.country, false);
