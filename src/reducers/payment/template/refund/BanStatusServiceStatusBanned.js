    ...
    return (
      <Layout>
        ...
        <Body textStyle={textStyle}>
          ...
          <div>
                        Мы заблокировали вашу учетную запись за нарушение наших условий.
                                 	</div>
          <EmptySpace height={20} />
          <div>
                        Пожалуйста, свяжитесь с нашей <a href={mailTo}>технической поддержкой</a>, если у Вас остались вопросы.
					</div>
