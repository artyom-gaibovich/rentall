...
class Sticky extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    const isValid = !maximumStay && availability && startDate != null && endDate != null;
    ...
    document.addEventListener('scroll', () => {
      let top = document.documentElement.scrollTop || document.body.scrollTop,
        ...
        isWeb = (document.documentElement.clientWidth || document.body.clientWidth) >= 1200;
      ...
      [].forEach.call(stickies, (sticky) => {
        const stickyInitialWidth = parseFloat(sticky.getAttribute('data-sticky-width'), 10);
