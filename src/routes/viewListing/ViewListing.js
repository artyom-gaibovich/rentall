...
class ViewListing extends React.Component {
  ...
  render() {
    ...
    const basePriceValue = UserListing && UserListing.listingData && UserListing.listingData.basePrice ? UserListing.listingData.basePrice : 0;
    const currencyValue = UserListing && UserListing.listingData && UserListing.listingData.currency ? UserListing.listingData.currency : 'USD';
    ...
    const reviewsCount = UserListing.reviewsCount;
    const reviewsStarRating = UserListing.reviewsStarRating;
              ...
              <Element name="test1" className="element">
                <Grid fluid className={cx(s.horizontalLineThrough)}>
                  ...
                  </Row>
                  {
                    ...
                    <Grid
                      fluid className={cx(s.space2, s.noPaddingMobile,
