...
class UserDetail extends Component {
  ...
  render() {
    ...
    if (verifications) {
      ...
      if (verifications.isOdnoklassnikiConnected) { totalVerification += 1; }
      if (verifications.isVkConnected) { totalVerification += 1; }
      if (verifications.isYandexConnected) { totalVerification += 1; }
