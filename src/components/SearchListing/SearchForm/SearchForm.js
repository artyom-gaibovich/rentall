...
class SearchForm extends React.Component {
  ...
  render() {
    ...
    const bedrooms = fieldsSettingsData.bedrooms;
    const bathrooms = fieldsSettingsData.bathrooms;
    const beds = fieldsSettingsData.beds;
    const amenities = fieldsSettingsData.essentialsAmenities;
    const spaces = fieldsSettingsData.spaces;
    const houseRules = fieldsSettingsData.houseRules;
    const fish = fieldsSettingsData.fish;
        ...
        <form onSubmit={handleSubmit}>
          ...
          <Panel collapsible expanded={filterToggle} id={'filters'} className={cx(s.collapsePanel)}>
            ...
            <div className={cx(s.filterSection, s.filterSectionBottom)}>
              <Row>
                <Col lg={2} md={2} sm={12} xs={12} className={cx(s.sectionLabel)}>
                  <span><FormattedMessage {...messages.fish} /></span>
                </Col>
                <Col lg={9} md={9} sm={12} xs={12}>
                  <Field name="fish" component={this.checkboxGroup} options={fish} />
                </Col>
              </Row>
            </div>
            {
