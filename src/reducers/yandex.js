              ...
              if (req.user) {
                ...
                if (userLogin) {
                  if (userLogin.userBanStatus == 1) {
                                // console.log('start user verified profile update 0')
                    done(null, {
                      id: userLogin.id,
                      email: userLogin.email,
                      type: 'userbanned',
                    });
                                // console.log('end user verified profile update 0')
                  } else if (userLogin.userDeletedAt != null) {
                                // console.log('start user verified profile update 1')
                    done(null, {
                      id: userLogin.id,
                      email: userLogin.email,
                      type: 'userDeleted',
                    });
                                // console.log('end user verified profile update 1')
                  } else {
                                // console.log('start user verified profile update 2')
                    ...
                    await UserVerifiedInfo.update(
                      ...
                      type: 'login',
                                ...
                                // console.log('end user verified profile update 2')
                  }
                } else {
                            // console.log('start user verified profile update 3')
