      ...
      <Grid className={s.whybnb}>
        <Row className={s.videosection}>
          <Col xs={12} sm={12} md={12} lg={12}>
            <Col xs={12} sm={12} md={12} lg={12}>
              <div className={cx(s.seperator, s.boxseperator)} />
              <div className={s.mainhedding}>
                <h1>Lorem Ipsum </h1>
                <iframe width="100%" height="526" src="https://www.youtube.com/embed/C0DPdy98e4c" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
              </div>
            </Col>
          </Col>
        </Row>
