        ...
        <div>
          ...
          <div className={cx('table-responsive', 'NewAdminResponsiveTable', 'NewResponsiveTableAdmin')}>
            ...
            >
              ...
              {
                                reportUserManagement && reportUserManagement.reportsData.length > 0 && reportUserManagement.reportsData.map((value, index) => {
                                  const date = moment(value.createdAt).format('MM/DD/YYYY');
                                  return (
                                    <Tr key={index}>
