                            ...
                            {/* {!load ? (
                                ...
                                <Row className={cx(s.space4, s.spaceTop2, s.responsivecardSection)}>
                                    <Col
                                        ...
                                        sm={8}
                                        xs={12}
                                        className={cx(s.noPadding, s.spaceTop2, s.cardSection)}
                                    >
                                        <div className={'placeHolderFont'}>
                                            <Col lg={12} md={12} sm={12} xs={12}>
                                                ...
                                                <Field name="cardNumber" component="input" type="text" />
                                            </Col>
                                            <Col lg={6} md={6} sm={6} xs={6}>
                                                ...
                                                <Row>
                                                    <Field name="expiryDate" component="input" type="text" />
                                                    <Field name="expiryYear" component="input" type="text" />
                                                </Row>
                                            </Col>
                                            <Col lg={6} md={6} sm={6} xs={6}>
                                                <label className={s.labelText}>
