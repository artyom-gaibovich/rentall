  ...
  render() {
    ...
    return (
      <div className={s.positionRelative}>
        <img src="../../../images/home/footerImg-07.03.webp" className={s.footerImage}/>
        <div
        ...
        >
          <div className={s.container}>
            <div className={cx(s.footerSectionContainer, 'hidden-print')}>
              <Grid fluid className={s.footerTextMargin}>
                <Row style={{marginTop: "400px"}}>
                  <div className={s.responsivePadding}>
                    <Col sm={4} md={4} lg={4} xs={12} className={cx(s.responsiveMargin, s.noPaddingMobile)}>
                    ...
                    <Col sm={4} md={4} lg={4} xs={12} className={cx(s.responsiveMargin, s.noPaddingMobile)}>
                      ...
                      <ul className={s.listContainer}>
                        <li>
                          <Link to={'/become-a-host'} className={s.textLink} >
          ...
          <div className={s.greenFooterBlock}>
            <span className={s.sandLine}></span>
            <p className={s.copyrightText}>«GOODTRIP» предоставляет сервис по онлайн бронированию объектов размещения и тревел услуг и не является туристическим оператором.</p>
            <h3 className={s.copyrightHeader}>Copyright</h3>
          </div>
        </div>
      </div>
    );
