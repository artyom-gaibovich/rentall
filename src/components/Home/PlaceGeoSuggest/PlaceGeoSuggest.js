...
//     suggestView1.state.events.add('select', function (event) {
//       let value = event.get('item').value;

//       // setTimeout(function(){
//       //   setPersonalizedValues({ name: 'geography', value: suggestView1.state._data.items[0].type });
//       // setPersonalizedValues({ name: 'location', value: suggestView1.state._data.items[0].type });
//       // },1000);
//  });
// }
  ...
  onChange(value) {
    ...
    // PlaceGeoSuggest.inputValue = value;
