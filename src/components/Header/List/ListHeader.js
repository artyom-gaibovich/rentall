    ...
    return (
      <div className={s.root}>
        ...
        <div className={s.container}>
          <Navbar fluid className={cx(s.rentAllHeader, 'ListHeader', 'listHeaderAR')} fixedTop expanded={false}>
            <Navbar.Header>
              <Navbar.Brand className={cx('hidden-xs', s.breakPoint, 'listHeaderLogo')} >
                <Logo link={'/'} className={cx(s.brand, s.brandImg)} />
              </Navbar.Brand>
              <Navbar.Toggle
                className={cx(s.brandBorder, s.navBarToggle, s.navBarToggleList, 'brandBorderRtl')} children={
              ...
              />
              <Navbar.Toggle
                className={cx(s.exitToggle, s.navBarToggle, 'exitToggleRtl')} children={
                  <span>
                    <SaveButton
                      step={step}
                      formPage={formPage}
