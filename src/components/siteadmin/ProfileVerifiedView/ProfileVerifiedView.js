...
class ProfileVerifiedView extends React.Component {
  ...
  render() {
    ...
    const isVerifiedInfo = data && data.userVerifiedInfo;
    const isVerify = !!(
        data &&
        data.userVerifiedInfo &&
        (data.userVerifiedInfo.isEmailConfirmed ||
            data.userVerifiedInfo.isGoogleConnected ||
            data.userVerifiedInfo.isIdVerification ||
            data.userVerifiedInfo.isFacebookConnected ||
            data.userVerifiedInfo.isOdnoklassnikiConnected ||
            data.userVerifiedInfo.isVkConnected ||
            ddata.userVerifiedInfo.isYandexConnected ||
    ...
    if (isVerifiedInfo && data.userVerifiedInfo.isOdnoklassnikiConnected == true) {
      isOdnoklassniki = 'Odnoklassniki';
    }
