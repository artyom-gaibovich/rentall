            ...
            <Col xs={12} sm={12} md={12} lg={12}>
              ...
              }
              {
                !loading && showPayouts && <div className={cx(s.select, 'selectPayoutRTL')}>
                  <Payouts
                    className={cx(s.formWidth, s.formControlSelect, s.space1, bt.commonControlSelect, 'commonControlSelectPayoutRTL')} refetch={refetch}
              ...
              }
              {
                !loading && <div className={s.select}>
                  <Listings
                    className={cx(s.formWidth, s.formControlSelect, s.space1, bt.commonControlSelect, s.spaceTop1, 'commonControlSelectPayoutRTL')} refetch={refetch}
                    mode={page}
                    handleResults={this.handleChange}
                    payoutId={payoutId}
                    listId={listId}
