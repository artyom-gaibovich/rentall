...
class WishListModal extends Component {
  ...
  componentDidMount() {
    ...
    const coverPhoto = UserListing && UserListing.coverPhoto;
    const coverImage = UserListing && UserListing.listPhotos && UserListing.listPhotos.find(o => o.id == coverPhoto);
    const path = '/images/upload/x_large_';
    let showImage;
    if (coverImage) {
