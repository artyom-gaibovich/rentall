...
class Logo extends Component {
  ...
  render() {
    ...
    const defaultLogoHeight = logoHeight && logoHeight != null ? logoHeight : '63';
    const defaultLogoWidth = logoWidth && logoWidth != null ? logoWidth : '250';
    const defaultHomeLogoHeight = homeLogoHeight && homeLogoHeight != null ? homeLogoHeight : '63';
    const defaultHomeLogoWidth = homeLogoWidth && homeLogoWidth != null ? homeLogoWidth : '63';
    ...
    return (
      <Link to={link} className={className}>
        {/* {
                    ...
                    <img
                      src={`/images/logo/${homeLogo}`} className={cx(!showMenu ? 'displayBlock' : 'displayNone')}
                ...
                }
        {
                    homeLogo && location === '/' && logoImage && layoutType == 2 &&
                    <img
                      src={`/images/logo/${logoImage}`} className={cx(!showMenu ? 'displayBlock' : 'displayNone')}
