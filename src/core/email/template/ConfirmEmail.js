    ...
    return (
      <Layout>
        ...
        <Body textStyle={textStyle}>
          ...
          <div>
            Добро пожаловать в {sitename}! Для того, чтобы начать, вам необходимо подтвердить свой адрес электронной почты.
          </div>
          <EmptySpace height={40} />
          <div>
            <a style={buttonStyle} href={verificationURL}>Подтвердить E-mail</a>
          </div>
