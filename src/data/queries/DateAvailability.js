...
const DateAvailability = {
  ...
  async resolve({ request, response }, { listId, startDate, endDate }) {
    const convertStart = moment(startDate).format('YYYY-MM-DD 00:00:00');
    const convertEnd = moment(endDate).subtract(1, 'day').format('YYYY-MM-DD 23:59:59');
